...
class Unet:
    ...
    def UnetConv2D(self, input, filters, kernel=(3, 3), activation="relu", padding="same"):
        conv = Conv2D(filters, kernel, activation=activation,
    ...
    def model_fn(self, mode, inputs, params, reuse=False):
        ...
        mean_iou, conf_mat = tf.metrics.mean_iou(
            labels, prediction, num_classes=2)
        ...
        model_spec['metrics_init_op'] = tf.variables_initializer(
            metric_variables)
